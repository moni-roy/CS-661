...
#' 
## ---- fig.align='center', fig.cap='Volcano plot of the genes with an absolute log fold change > 1 and p-value < 0.05 in red and the remaining ones in black'----
plot(
  x = df$LogFC,
  y = -log10(df$PValue),
  xlab = 'logFC',
...
#' 
## ---- fig.align='center', fig.cap='The distribution function of log base 2 expression levels for the data', fig.dim = c(8, 6)----
...
#' 
## ---- fig.align='center', fig.cap='Box plots to compare the gene’s values in control versus treated'--------------------------
